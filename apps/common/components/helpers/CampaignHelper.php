                ...
                if (stripos($tagValue, 'BLOCK') !== false && strpos($tagValue, ':') !== false) {
                    ...
                    if (!empty($rndModel)) {
	                    ...
	                    if (CampaignHelper::contentHasXmlFeed($tagValue)) {
		                    $tagValue = CampaignXmlFeedParser::parseContent($tagValue, $campaign, $subscriber, true, null, $server);
	                    }
	                    if (CampaignHelper::contentHasJsonFeed($tagValue)) {
		                    $tagValue = CampaignJsonFeedParser::parseContent($tagValue, $campaign, $subscriber, true, null, $server);
	                    }
